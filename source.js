...
switch(abc){
    ...
    case 4:
     ...
     break;    
    case 5:
     alert("your relation with "+user1+" is partner");
     document.write("your relationship  with ",user1," is partner");
     break;    
    case 6:
     alert("your relation with "+user1+" is love");
     document.write("your relationship with ",user1," is love");
     break;    
    case 7:
     alert("your relation with "+user1+" is eneny");
    ...
    case 10:
     ...
     break;
    default:
     alert("your relationship with "+user1+" is enemy");
     document.write("your relationship with ",user1,"is enemy");
     }
     }
else{
